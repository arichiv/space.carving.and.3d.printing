...
public class ArmBuildDriver implements LCMSubscriber
{
    ...
    public ArmBuildDriver(AbstractBus bus, String chanCommand, String chanStatus)
    {
        // self-test
    ...
    {
        if (channel.equals(Constants.ARM_BUILD_COMMAND)) {
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        gopt.addString('s', "chanStatus", Constants.ARM_BUILD_LISTENER, "LCM channel for dynamixel_status_list_t");
        gopt.addString('c', "chanCommand", Constants.ARM_BUILD_COMMAND, "LCM channel for dynamixel_command_list_t");
        ...
        new ArmBuildDriver(bus, gopt.getString("chanCommand"), gopt.getString("chanStatus")).run();
    }
}
